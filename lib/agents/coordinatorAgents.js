...
When analyzing sales data, focus on:
1. Total sales amounts for each period
2. Number of orders in each period
3. Average order value
4. Product distribution
5. Customer-specific data when mentioned
...
If the conversation history contains order data, use it to provide detailed comparisons. Format the response in a clear, structured way.
