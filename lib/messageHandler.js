...
//====================================================================================
/**
 * Main handleTelegramMessage function for processing incoming Telegram messages
 ...
 */
//====================================================================================
export async function handleTelegramMessage(req) {
  ...
  try {
    ...
    let response;
    // Route questions to specialized agents based on the analysis
    ...
    switch (analysis.agentType) {
      case "COMPARISON_AGENT":
        response = await comparisonAgent.handle(messageText, userId);
        break;
      case "DAILY_SALES_AGENT":
        response = await dailySalesAgent.handle(messageText, userId);
        break;
      case "REFUND_AGENT":
        response = await refundAgent.handle(messageText, analysis.orderNumber);
        break;
      ...
      case "ORDER_STATUS_AGENT":
        response = await orderStatusAgent.handle(messageText, userId);
        break;
      case "CUSTOMER_ORDERS_AGENT":
        ...
        break;
      case "HELP_AGENT":
        response = await helpAgent.handle(messageText, userId);
        break;
      default:
        response =
